...
import com.zenzer0s.kite.database.backup.BackupUtil.BackupDestination
import com.zenzer0s.kite.database.backup.BackupUtil.BackupType
import com.zenzer0s.kite.ui.component.DialogSubtitle
import com.zenzer0s.kite.ui.component.SealDialog
import com.zenzer0s.kite.ui.component.SingleSelectChip
...
private fun PreviewExport() {
    KiteTheme { ExportDialog() { _, _ -> } }
}

@Preview(uiMode = Configuration.UI_MODE_NIGHT_YES, name = "Dark")
@Composable
private fun PreviewImport() {
    KiteTheme { ImportDialog() { _ -> } }
}
