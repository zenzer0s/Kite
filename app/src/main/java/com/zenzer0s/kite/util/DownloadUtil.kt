package com.zenzer0s.kite.util
...
import com.zenzer0s.kite.App.Companion.audioDownloadDir
import com.zenzer0s.kite.App.Companion.context
import com.zenzer0s.kite.App.Companion.videoDownloadDir
import com.zenzer0s.kite.Downloader
import com.zenzer0s.kite.Downloader.onProcessEnded
import com.zenzer0s.kite.Downloader.onProcessStarted
import com.zenzer0s.kite.Downloader.onTaskEnded
import com.zenzer0s.kite.Downloader.onTaskError
import com.zenzer0s.kite.Downloader.onTaskStarted
import com.zenzer0s.kite.Downloader.toNotificationId
...
import com.zenzer0s.kite.ui.page.settings.network.Cookie
import com.zenzer0s.kite.util.FileUtil.getArchiveFile
import com.zenzer0s.kite.util.FileUtil.getConfigFile
import com.zenzer0s.kite.util.FileUtil.getCookiesFile
import com.zenzer0s.kite.util.FileUtil.getExternalTempDir
import com.zenzer0s.kite.util.FileUtil.getFileName
import com.zenzer0s.kite.util.FileUtil.getSdcardTempDir
import com.zenzer0s.kite.util.FileUtil.moveFilesToSdcard
import com.zenzer0s.kite.util.PreferenceUtil.COOKIE_HEADER
